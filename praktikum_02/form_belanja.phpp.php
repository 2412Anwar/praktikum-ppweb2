        ...
        <div class="col-12 col-md-4" style="float: right;" id="card-container">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item bg-light">Kipas : Rp. 400.00</li>
                    <li class="list-group-item bg-light">Magicom : Rp. 900.00</li>
                    <li class="list-group-item bg-light">Kulkas : Rp. 2.800.000</li>
                </ul>
            </div>
            <div class="card-footer bg-primary text-white">Harga Normal</div>
        </div>
